...
import com.dynatrace.vectorscan.utils.LoadGenerator;
import com.dynatrace.vectorscan.utils.RegexGenerator;
import java.io.*;
...
@Fork(1)
public class RegexMatchingBenchmark {
    ...
    public static class BenchmarkState {
        ...
        public void setupScanners() {
            ...
            for (var pattern : RegexGenerator.generateRandomRegexes(nExpressions)) {
        ...
        public void setupInput() throws IOException {
            ...
            try (FileWriter writer = new FileWriter(inputFile)) {
                for (long i = 0; i < 1024 * 1024 * 8; i++) {
                    var chArr = LoadGenerator.randomCharArr(128);
                    chArr[chArr.length - 1] = '\n';
                    writer.write(chArr);
                }
            }
            IO.println("Creation done. File saved at " + inputFile.toPath());
        }
    }
}
